...
single_output = wf.apply(params, single_data)  # type: ignore


print("Single walker evaluation:")
complex_logpsi = single_output["logpsi"]  # type: ignore
print("Single walker evaluation:")
print(f"  log(ψ) = {complex_logpsi.real:.6f} + {complex_logpsi.imag:.6f}j")  # type: ignore
