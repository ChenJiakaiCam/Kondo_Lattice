...
class OneAndTwoRDM(Estimator):
    ...
    def init(self, data: SolidData, rngs: PRNGKey) -> dict[str, Any]:
        ...
        r_prime_pool = self._init_electrons(
            key=key_init, num_samples=int(self.batch_size * self.ratio_naux_nbatch)
        )
    ...
    def evaluate_batch_walkers(
        ...
        r_prime_pool, _aux_stats, sampler_state = self._aux_sampler.step(
            batch_log_prob=self._log_fsum,
            data=r_prime_pool,
            state=sampler_state,
            rngs=rngs,
        ...
        new_state = {"r_prime_pool": r_prime_pool, "sampler_state": sampler_state}
